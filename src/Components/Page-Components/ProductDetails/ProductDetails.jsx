            ...
            return (
              <div key={i}>
                <div className="bg-red-500 md:pl-10 md:py-8 grid p-4 md:flex justify-center text-left">
                  <div>
                <img src={`http://localhost:1337${val.attributes.Image.data.attributes.formats.thumbnail.url}`} className='h-full'/>

                    {/* <img src={val.sttributes.Image} alt="" /> */}
                  </div>
                  <div className="md:grid md:col-span-3 md:ml-10">
                    <div className="text-md md:text-4xl font-bold">
                      {val.attributes.title}
                    </div>
                    <div className="text-sm md:text-lg">{val.attributes.subTitle}</div>
                    <div>
                      <div className="text-md md:text-4xl font-bold">

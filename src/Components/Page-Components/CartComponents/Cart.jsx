  ...
  return (
    <div>
      <div className="bg-red-500 md:pl-10 md:py-8">
        {CartData?.map((val, i) => {
          return (
            <div key={i} className=" grid p-4 md:flex justify-center text-left">
              <div>
                <img src={val.image} alt="" />
              </div>
              <div className="md:grid md:col-span-3 md:ml-10">
                <div className="text-md md:text-4xl font-bold">{val.title}</div>
                <div className="text-sm md:text-md">{val.subTitle}</div>
                <div>
                  <div className="text-md md:text-4xl font-bold">{val.price}</div>
